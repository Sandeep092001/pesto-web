    ...
    <div>
      <div className="container mx-auto mt-4 flex justify-between">
        ...
        <div className="w-1/2">
          ...
          <form className="max-w-md mx-auto pt-5 bg-white p-4 rounded">
          <div
            id="alert-1"
            className="flex items-center p-4 mb-4 mx-2 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
            role="alert"
          >
            <svg
            ...
            <div className="ms-3 text-sm font-medium text-center">
              Feel Free to Fill the Form! We will revert you shortly
            </div>
          </div>
